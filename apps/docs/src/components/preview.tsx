...
export function Preview({ children }: { children: ReactNode }) {
  return (
    <div className="not-prose group relative w-full rounded-xl border border-fd-border/60 bg-fd-card/30 shadow-sm transition-shadow duration-300 hover:shadow-md">
      <div className="absolute inset-0 rounded-xl bg-[radial-gradient(circle_at_1px_1px,_var(--color-fd-border)_0.5px,_transparent_0)] bg-[size:20px_20px] opacity-40 transition-opacity duration-300 group-hover:opacity-60" />
