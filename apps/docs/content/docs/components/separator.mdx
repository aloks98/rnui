...
<Preview code={`<div className="w-[300px] space-y-4">
...
<Preview code={`<div className="flex h-5 items-center space-x-4 text-sm">
  <div>Blog</div>
  <Separator orientation="vertical" />
  <div>Docs</div>
  <Separator orientation="vertical" />
...
<Preview code={`<div className="w-[400px] space-y-6">
  <div>
...
<Preview code={`<div className="flex h-9 items-center gap-2">
...
<Preview code={`<div className="w-[300px] rounded-md border">
