...
<Preview code={`<Stepper defaultValue={2} className="w-full max-w-md space-y-8">
    <StepperNav>
      {[1, 2, 3, 4].map((step) => (
...
<Preview code={`<div className="flex items-center justify-center">
    <Stepper
