...
function normalizeTheme(
  ...
  if (themeProp === undefined)
    return {
      themeName: shadcnThemeName(autoMode),
      mode: autoMode,
      isShadcn: true,
    }
  ...
  if (t === 'shadcn-dark') return { themeName: t, mode: 'dark', isShadcn: true }
  if (t === 'shadcn-light')
 ...
 */
const EChart: ForwardRefExoticComponent<ChartProps & RefAttributes<ChartRef>> =
